const dishes = [
    ...
    { keyword: 'mushroomsoup', name: 'Грибной суп-пюре', price: 185, category: 'soup', kind: 'veg', count: '330 г', image: 'img/soups/mushroom.jpg' },
    { keyword: 'norwegian', name: 'Норвежский суп', price: 270, category: 'soup', kind: 'fish', count: '330 г', image: 'img/soups/norwegian.jpg' },
    { keyword: 'ramen', name: 'Рамен', price: 375, category: 'soup', kind: 'meat', count: '425 г', image: 'img/soups/ramen.jpg' },
    { keyword: 'tomyam', name: 'Том ям с креветками', price: 650, category: 'soup', kind: 'fish', count: '500 г', image: 'img/soups/tomyam.jpg' },
    ...
    { keyword: 'friedpotatoes', name: 'Жареная картошка с грибами', price: 150, category: 'main', kind: 'veg', count: '250 г', image: 'img/main_course/friedpotato.jpg' },
    { keyword: 'chickencutlet', name: 'Котлеты из курицы с пюре', price: 225, category: 'main', kind: 'meat', count: '280 г', image: 'img/main_course/chickencutlet.jpg' },
    ...
    { keyword: 'saladwhitegreens', name: 'Салат с зелеными овощами', price: 330, category: 'salad', kind: 'veg', count: '220 г', image: 'img/salads_starters/saladwhitegreen.jpg' },
    ...
    { keyword: 'chocolatetort', name: 'Шоколадный торт', price: 270, category: 'dessert', kind: 'medium', count: '140 г', image: 'img/desserts/chocolatetort.jpg' },
